...
[![Version](https://img.shields.io/badge/version-3.0.4-06B6D4?style=for-the-badge)](https://github.com/trsoliu/mini-wiki/releases)
...
Mini-Wiki 3.0.4 内置了 **11 个开箱即用的插件**，覆盖分析、生成、增强、格式化四大类别。
